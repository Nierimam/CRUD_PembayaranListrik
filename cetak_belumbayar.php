...
FROM
  ...
  `tbtarif` ON `tbtagihan`.`KodeTarif` = `tbtarif`.`KodeTarif` ";
    ...
    <p>
        Silahkan Melakukan Pembayaran Transaksi Melalui Transfer Bank ke Rekening BCA : 2343234 Atas Nama PT. PLN, Dimana Batas Proses Transaksi Pembayaran Sebelum Tgl 10 Bulan Berjalan. Jika Melewati Batas Tanggal Tersebut, Maka Listrik Akan disegel.
        <br />
        <br />
        (Admin)
    </p>
